...
import com.zzh.zoom.swipe.BaseSwipeListViewListener;
import com.zzh.zoom.swipe.SwipeListView;
...
public class SwipeListViewExampleActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: -------count--------"+adapter.getItemCount());
